...
app.get('/health', (_, res) => res.json({ ok: true, rooms: rooms.size, version: '0.7.3-full-motion-animation' }));
...
io.on('connection', (socket) => {
  socket.emit('ready', { version: '0.7.3-full-motion-animation' });
...
server.listen(PORT, () => {
  console.log(`Loot Goblins v0.7.3 Full Animation / Motion Deep Dive listening on ${PORT}`);
});
