...
app.get('/health', (_, res) => res.json({ ok: true, rooms: rooms.size, version: '0.10.10-event-priority-modal-cleanup-v0610' }));
...
function serializeRoom(room, viewerId) {
  ...
  return {
    version: '0.10.10-event-priority-modal-cleanup-v0610',
    code: room.code,
    status: room.status,
    phase: room.phase,
...
io.on('connection', (socket) => {
  socket.emit('ready', { version: '0.10.10-event-priority-modal-cleanup-v0610' });
